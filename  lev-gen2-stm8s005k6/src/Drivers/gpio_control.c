...
unsigned char getPIC_OVP_Status(){
  return (GPIO_ReadInputPin(OVP_PORT, OVP_PIN)== 0)? false : true;
}
unsigned char getPIC_UVP_Status(){
  return (GPIO_ReadInputPin(UVP_PORT, UVP_PIN)== 0)? false : true;
}
