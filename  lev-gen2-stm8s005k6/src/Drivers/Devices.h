...
unsigned char _Device_Get_Button_Status(void);
void _Device_Set_Interrupt_ButtonEvent_Press_Trigger_Function(void (*calling_fun)());
void _Device_Remove_Interrupt_ButtonEvent_Press_Trigger_Function(void);
...
unsigned char _Device_Get_PIC_UVP_Status(void);
unsigned char _Device_Get_PIC_OVP_Status(void);
...
void _Device_Start_ADC_Conversion(void);
void _Device_Stop_ADC_Conversion(void);
void _Device_Set_Interrupt_ADC_Conversion_Finish_Function(void (*calling_fun)(void));
void _Device_Remove_Interrupt_ADC_Conversion_Finish_Function(void);
...
* AWU Timer init  																*
********************************************************************************/
void _Device_AWU_HALT_Timer_Init(void);
void _Device_Disable_AWU_HALT_Timer(void);
void _Device_Set_AWU_Shorter_Timer_Interval_Time_Base(void);
void _Device_Set_AWU_Longer_Timer_Interval_Time_Base(void);
void _Device_Set_AWU_Interrupt_Timer_Calling_Function(unsigned char fun_index, void (*calling_fun)(void));
...
void _Device_Remove_Interrupt_Uart_Receive_Frame_Calling_Function(void);
#if defined(_COSMIC_)	
...
unsigned char _Device_EEPROM_ReadWholeEEPROMToInternalMemory(void);
unsigned char _Device_EEPROM_Set_Data_ToInternalMemory(unsigned char offset, unsigned char *array, unsigned char length);
unsigned char _Device_EEPROM_WriteWholeEEPROMFromInternalMemory(void);
